...
const Hero = () => {
  return (
    <section
      className={`${styles.container} mt-20 p-10 items-center lg:grid grid-cols-2 lg:mx-20 lg:gap-[5%] lg:p-0 `}
    >
      <div
        className={`${styles.imageContainer} relative w-full h-[80%]  overflow-hidden flex items-center`}
      >
        <Image
      ...
      >
        <div className="text-3xl lg:text-4xl font-medium tracking-wider leading-loose mt-8  lg:mt-0 h-[200px] lg:h-[20%]">
          <p>
            {" "}
